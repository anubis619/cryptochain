...
describe('Block', () => {
    ...
    it('has a timestamp, lashHash, hash, and data prop', () =>{
    ...
    describe('mineBlock()', () =>{
        ...
        it('creates a SHA-256 `has` based on the proper inputs', () => {
        ...
        it('sets a `hash` that matches the difficulty criteria', () =>{
            expect(hextToBinary(minedBlock.hash).substring(0, minedBlock.difficulty)).toEqual('0'.repeat(minedBlock.difficulty));
        });
